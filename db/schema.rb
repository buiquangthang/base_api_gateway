...
ActiveRecord::Schema.define(version: 2019_09_25_111846) do

  create_table "freelance_documents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.text "file_url"
    t.text "image_url"
